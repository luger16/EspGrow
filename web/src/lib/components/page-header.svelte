...
<header
	class="sticky top-0 z-40 flex h-14 shrink-0 items-center gap-2 rounded-t-xl bg-background px-4 md:relative"
>
	...
	<div class="ml-auto flex items-center gap-2">
		<div class="flex items-center gap-1.5 rounded-full bg-muted px-2.5 py-1">
			<div
				class="size-1.5 rounded-full {websocket.connected
					? 'bg-green-500'
